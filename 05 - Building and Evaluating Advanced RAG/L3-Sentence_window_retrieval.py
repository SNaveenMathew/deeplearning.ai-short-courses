...
eval_questions = []
with open('example_files/generated_questions.text', 'r') as file:
    for line in file:
...
# - Since this evaluation process takes a long time to run, the following file `example_files/generated_questions.text` contains one question (the one mentioned in the lecture video).
...
# 
# > - `example_files/generated_questions_01_05.text`
# > - `example_files/generated_questions_06_10.text`
# > - `example_files/generated_questions_11_15.text`
# > - `example_files/generated_questions_16_20.text`
# > - `example_files/generated_questions_21_24.text`
# 
